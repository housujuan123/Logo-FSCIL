...
def set_up_datasets(args):
    ...
    if args.dataset == 'mini_imagenet':
        ...
        args.shot = 5
        args.sessions = 11
    if args.dataset == 'foodlogo':
        import dataloader.foodlogo.miniimagenet as Dataset
        args.base_class = 100
        args.num_classes=200
        args.way = 10
        args.shot = 5
        args.sessions = 11
    if args.dataset == 'mini2k':
        import dataloader.mini2k.miniimagenet as Dataset
        args.base_class = 130
        args.num_classes=230
        args.way = 10
        args.shot = 5
        args.sessions = 11
    if args.dataset == 'inc32':
        import dataloader.inc32.miniimagenet as Dataset
        args.base_class = 60
        args.num_classes=100
        args.way = 5
        args.shot = 5
